...
exports.showTasks = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const count = yield Task.find(Object.assign(Object.assign({}, keyword), { stage: {
            $in: [...stageFilter],
        }, priority: PriorityFilter })).countDocuments();
    //stat for task
    const countStat = yield Task.find({}).countDocuments();
    try {
        const tasks = yield Task.find(Object.assign(Object.assign({}, keyword), { stage: {
                $in: [...stageFilter],
